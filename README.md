...
| **World cartridges** (generated; the playthrough — pin + patch ledger — persists per campaign in the token namespace) | `world_catalog`, `world_begin`, `world_node`, `world_powers`, `world_lineage`, `world_commit`, `world_replay` |
